...
**One important caveat:** the model works best with measured pigment data. Since the paint database uses approximate hex codes rather than laboratory-measured values, the suggestions are a useful starting point for real experimentation rather than an exact prescription.
